...
abstract class Accept implements BufferReferer {
    ...
    void acceptInteger(byte v) throws IOException {
        throw new RuntimeException("Unexpected integer value");
    }
    ...
    // throw new RuntimeException("Unexpected raw value");
    // }
    ...
    // throw new RuntimeException("Unexpected map value");
    // }
    ...
    void acceptNil() throws IOException {
        throw new RuntimeException("Unexpected nil value");
    }

    void acceptFloat(float v) throws IOException {
        throw new RuntimeException("Unexpected float value");
    }
